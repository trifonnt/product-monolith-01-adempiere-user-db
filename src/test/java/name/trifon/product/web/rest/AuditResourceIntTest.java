...
import name.trifon.product.ProductApp;
import name.trifon.product.config.audit.AuditEventConverter;
import name.trifon.product.domain.PersistentAuditEvent;
import name.trifon.product.repository.PersistenceAuditEventRepository;
import name.trifon.product.service.AuditEventService;
