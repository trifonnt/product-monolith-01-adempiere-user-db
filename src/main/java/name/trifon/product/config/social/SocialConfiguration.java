package name.trifon.product.config.social;

import name.trifon.product.repository.SocialUserConnectionRepository;
import name.trifon.product.repository.CustomSocialUsersConnectionRepository;
import name.trifon.product.security.social.CustomSignInAdapter;
